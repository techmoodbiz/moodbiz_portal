...
const HistoryAuditsTab: React.FC<HistoryAuditsTabProps> = ({ auditors, brands, availableBrands }) => {
  ...
  return (
    <div className="animate-in fade-in h-full flex flex-col">
      <SectionHeader title="Audit Archive" subtitle="Dữ liệu đối soát rủi ro & tuân thủ SOP Markdown toàn hệ thống.">
      ...
      {isAuditorDetailOpen && selectedAuditor && (
          ...
          <div className="bg-white w-full max-w-6xl rounded-[3rem] shadow-2xl flex flex-col max-h-[92vh] overflow-hidden animate-in zoom-in-95">
            ...
            <div className="flex-1 overflow-y-auto p-10 grid lg:grid-cols-12 gap-10 custom-scrollbar bg-slate-50/20">
                <div className="lg:col-span-8 space-y-8">
                   <div className="grid md:grid-cols-2 gap-8">
                      ...
                      <div className="bg-[#102d62] rounded-[2rem] border border-blue-900 shadow-premium overflow-hidden flex flex-col text-white">
                         ...
                         <div className="p-8 text-[14px] text-blue-50 font-medium leading-[1.8] whitespace-pre-wrap flex-1">
                   ...
                   <div className="bg-white p-10 rounded-[2.5rem] border border-slate-50 shadow-premium">
                      ...
                      <div className="space-y-6 overflow-y-auto custom-scrollbar pr-2 flex-1">
                         {selectedAuditor.output_data?.identified_issues?.length > 0 ? (
                           selectedAuditor.output_data.identified_issues.map((issue: any, idx: number) => (
                              <div key={idx} className="p-5 rounded-3xl bg-slate-50 border border-slate-100 animate-in fade-in slide-in-from-bottom-2">
