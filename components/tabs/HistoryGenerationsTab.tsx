...
const HistoryGenerationsTab: React.FC<HistoryGenerationsTabProps> = ({
  ...
  const handleQuickAudit = async () => {
    ...
    const platformRules = PLATFORM_CONFIGS[platform]?.audit_rules || "Kiểm duyệt theo tiêu chuẩn nội dung chung.";
    ...
    const basePrompt = isWebsite ? (systemPrompts.auditor as any).website : (systemPrompts.auditor as any).social;
    ...
    const prompt = basePrompt
      ...
      .replace(/{product_context}/g, "Sử dụng dữ liệu brand chung.");
  ...
  return (
    <>
      <div className="animate-in fade-in flex-1 flex flex-col">
        <SectionHeader title="Generator History" subtitle="Kho lưu trữ bản thảo đã được xử lý bởi AI.">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-12">
          {filteredGenerations.length === 0 ? (
            <div className="col-span-full py-32 bg-white rounded-[3rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center text-slate-400">
              ...
              <p className="font-bold text-lg text-slate-400">Hệ thống chưa có bản ghi Generator nào</p>
            </div>
      ...
      {isGenDetailOpen && selectedGeneration && currentUser && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-[1400px] rounded-[3rem] shadow-2xl flex flex-col h-[92vh] overflow-hidden animate-in zoom-in-95">
            ...
            <div className="flex-1 overflow-hidden bg-slate-50/20 flex flex-col lg:flex-row">
